...
The first three workflow guides do not use an LLM. They cover validation,
explanation, summarization, vocabulary lookup, and graph conversion.
...
1. [Generate one signal fragment with Ollama](guides/Lecture-11-llm-generate-one-signal/)
2. [Generate one artifact with an online provider](guides/Lecture-12-llm-use-online-provider/)
3. [Generate a full fragment set from source documents](guides/Lecture-13-llm-generate-fragment-set/)
4. [Full cycle: source docs to catalog HTML and graph explorer](guides/Lecture-14-llm-full-cycle-catalog-and-graph/)
